...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "aquamarine4"))))
 ...
 '(font-lock-regexp-grouping-construct ((t (:foreground "turquoise3"))))
 '(font-lock-doc-face ((t (:foreground "light sky blue"))))
 '(font-lock-doc-string-face ((t (:foreground "sky blue"))))
 '(font-lock-function-name-face ((t (:bold t :foreground "turquoise2" :weight bold))))
 '(font-lock-keyword-face ((t :foreground "aquamarine4")))   ;;"#5DADE2")))) ;; 2980B9 :weight bold)))) ;; "aquamarine4"
 ...
 '(font-lock-variable-name-face ((t (:bold t :foreground "turquoise1" :weight bold))))
